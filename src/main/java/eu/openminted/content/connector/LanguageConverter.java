...
public class LanguageConverter {
    ...
    */
    ...
    private LanguageConverter() {
        ...
        _openaire_name_to_openminted_name.put("Greek", "Modern Greek (1453-)");
        _openaire_name_to_openminted_name.put("Ancient Greek", "Ancient Greek (to 1453)");
        ...
        _openaire_name_to_openminted_name.put("Nynorsk, Norwegian; Norwegian Nynorsk", "Norwegian Nynorsk");
        _openaire_name_to_openminted_name.put("Bokmål, Norwegian; Norwegian Bokmål", "Norwegian Bokmål");
        _openaire_name_to_openminted_name.put("Bokm?l, Norwegian; Norwegian Bokm?l", "Norwegian Bokmål");
        ...
        _openaire_name_to_openminted_name.put("Middle English", "Middle English(1100-1500)");
        _openaire_name_to_openminted_name.put("Middle Dutch", "Middle Dutch (ca. 1050-1350)");
        _openaire_name_to_openminted_name.put("Middle French", "Middle French (ca. 1400-1600)");
        _openaire_name_to_openminted_name.put("Middle High German", "Middle High German (ca. 1050-1500)");
        _openaire_name_to_openminted_name.put("Middle Irish", "Middle Irish (900-1200)");
